...
<template>
  <div>
    ...
    <div>
      ...
      <div><p>生年月日と性別を入力してください</p><input type="date" v-model="userCreationForm.birthday"/><select v-model="userCreationForm.gender"><option>女性</option><option>男性</option></select></div>
      ...
      <div style="visibility: hidden;"><p>パスワードが違います。</p></div>
